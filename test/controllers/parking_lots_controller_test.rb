...
class ParkingLotsControllerTest < ActionController::TestCase
  ...
  test "should create parking_lot" do
    assert_difference('ParkingLot.count') do
      post :create, parking_lot: { location_id: @parking_lot.location_id, name: @parking_lot.name, photo: @parking_lot.photo }
    end
  ...
  test "should update parking_lot" do
    patch :update, id: @parking_lot, parking_lot: { location_id: @parking_lot.location_id, name: @parking_lot.name, photo: @parking_lot.photo }
    assert_redirected_to parking_lot_path(assigns(:parking_lot))
  end
